...
"""Utility functions for composing user names.

Originally part of the parent KCWorks site package; relocated here so
that the Names vocabulary sync code in this submodule can compose
display names without inverting the dependency direction.
"""
